...
verified: false
verifier_chain:
  producer: null                # sub-agent ID
  reviewer: null                # different sub-agent ID
...
analysis:
  ...
  last_extracted_by: null

# ===== REVIEW POINTERS (links into DB2 — NueVue Review Archive) =====
reviews: []                     # [{review_id, review_type, ai_tier_used, file, date, citations_count}, ...]
